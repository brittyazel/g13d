...
namespace G13 {
    ...
    libusb_context* G13_Manager::usb_context;
    std::vector<G13_Device*> G13_Manager::g13s;
    libusb_hotplug_callback_handle G13_Manager::usb_hotplug_cb_handle[3];
    ...
    void G13_Manager::SignalHandler(const int signal) {
    ...
    std::string G13_Manager::MakePipeName(const G13_Device* usb_device, const bool is_input) {
    ...
    G13_State_Key G13_Manager::FindInputKeyValue(const std::string& keyname, bool down) {
    ...
    /*
        libusb_context *G13_Manager::getusb_context() {
            return usb_context;
        }
    
        void G13_Manager::setusb_context(libusb_context *newLibusbContext) {
            usb_context = newLibusbContext;
        }
    */
